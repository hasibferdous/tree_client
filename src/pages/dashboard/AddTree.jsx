...
const AddTree = () => {
  ...
  const handleCreateTree = async (e) => {
    ...
    await axios.post("http://localhost:3000/trees", treeData);
  };

  //alert-toast part starts
  const handleAdd = () => {
    confirmAction("Are you sure you want to add this tree item?", () => {
      toast.success("Tree Item Added Successfully");
    });
  };
  ...
  return (
    <div className="w-3/4 px-16 mt-24 ml-7 mr-7 shadow-xl rounded-xl bg-amber-200 font-bold">
      <h1 className="text-4xl mb-4 mt-8">Add Tree</h1>
